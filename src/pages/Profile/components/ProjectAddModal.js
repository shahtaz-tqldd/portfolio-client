...
const ProjectAddModal = () => {
    ...
    const handleProjectSubmit = data => {
        ...
        const projectInfo = {
            ...
            features: [
                "An Ecommerce website where a user can sell books and buy from other",
                "Firebase Authentication, MongoDB used to store product data",
                "User Dashboard management and Admin Authorization"
            ],
            ...
            <div className="modal">
                <div className="modal-box w-11/12 max-w-5xl relative">
                    ...
                    <form onSubmit={handleSubmit(handleProjectSubmit)} className='mt-8'>
                        ...
                        <h2 className='text-2xl text-success font-bold mt-5'>Upload Screenshots</h2>
                        {
                            imgBtnNum.map(() => <input {...register("img", { required: "This field can not be empty" })} type="file" className="my-2 input input-bordered" />)
                        }
                        <button onClick={() => setImgBtn(imgBtn + 1)} className='btn'>Add more +</button><br />
