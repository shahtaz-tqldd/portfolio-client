    ...
    return (
        <div className="hero">
            <div className="w-full hero-content flex-col lg:flex-row-reverse justify-between">
                ...
                <div className='lg:w-1/2 flex lg:flex-row md:flex-row flex-col-reverse justify-start lg:items-center gap-10' data-aos="fade-right">
                    <div className='text-2xl flex gap-6 lg:flex-col md:flex-col'>
                    ...
                    <div className='w-min-full'>
                        ...
                        <h1 className="lg:text-5xl md:text-4xl text-3xl font-bold flex">I am a&nbsp;
                            <TextTransition className="text-success" springConfig={presets.wobbly}>
                                {texts[index % texts.length]}
                            </TextTransition>
                        </h1>
                        <h1 className="lg:text-5xl md:text-4xl text-3xl font-bold flex">web Developer</h1>
